<%@ Page Language="C#" MasterPageFile="~/Employee/MasterPage.master" AutoEventWireup="true" CodeFile="frmPatientCheckin.aspx.cs" Inherits="Employee_frmAddInPatient" Title="Untitled Page" %>
      ...
      <table align="center" style="width: 770px">
        ...
        <tr>
            ...
            <td style="height: 5px; width: 184px; font-weight: bolder; font-size: 8pt; font-family: verdana;">
                <asp:DropDownList ID="pplCode" runat="server" Width="157px" 
                    AutoPostBack="True" onselectedindexchanged="pplCode_SelectedIndexChanged" >
                </asp:DropDownList></td>
            <td style="height: 5px; width: 184px; font-weight: bolder; font-size: 8pt; font-family: verdana;">
                In/Out Patient</td>
